...
#define STRING_CONFIG_H_AUTHOR "(Connor Wolf, default config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_LEAPFROG_CREATR_HS
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  11.00,  11.00 }
    #define DEFAULT_Ki_LIST {   0.40,   0.40 }
    #define DEFAULT_Kd_LIST {  70.00,  70.00 }
  #else
    #define DEFAULT_Kp 11.00
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  35.00
  #define DEFAULT_bedKi   0.6
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          {400, 400, 40, 400}
