...
#define BOARD_INFO_NAME "Leapfrog Creatr HS"
...
// Part cooling fan
#define FAN_PIN                                5
// Hot-End heatsink fan (needs to run when heaters are on)
// This isn't stock, you have to change do some rewiring for it to work
#define COLD_END_FAN_PIN                                6
